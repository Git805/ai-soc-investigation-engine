...
def generate_demo_events() -> list[SecurityEvent]:
    ...
    return [
        SecurityEvent(
            event_id="demo-login-001",
            timestamp=base,
            event_type=EventType.LOGON,
            severity=Severity.LOW,
            host={"hostname": "WS-001", "ip": "10.10.10.25"},
            user={"username": "jdoe"},
            source={"product": "SIEM", "vendor": "synthetic"},
            data={"result": "success"},
        ),
        SecurityEvent(
            event_id="demo-process-001",
            timestamp=base + timedelta(minutes=2),
            event_type=EventType.PROCESS_CREATION,
            severity=Severity.MEDIUM,
            host={"hostname": "WS-001", "ip": "10.10.10.25"},
            user={"username": "jdoe"},
            process={"name": "powershell.exe", "pid": 4212, "command_line": "powershell.exe -enc <synthetic>"},
        ...
        SecurityEvent(
            ...
            user={"username": "jdoe"},
            source={"product": "EDR", "vendor": "synthetic"},
            data={"destination_ip": "203.0.113.50", "destination_port": 443, "protocol": "tcp"},
        ),
    ]
